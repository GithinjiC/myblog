...
def post_detail(request, year, month, day, post):
    ...
    if request.method == 'POST':
        ...
        if comment_form.is_valid():
            # create comment object but don't save hastily(commit=false)
    ...
    return render(request, 'blog/post/detail.html', {'comments': comments, 'new_comment': new_comment,
...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'overseek254@gmail.com', [cd['to']])
            sent = True
    else:
        form = EmailPostForm()
